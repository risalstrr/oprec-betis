...
const Post = (props: any) => {
  ...
  let trimmedString = props.name.substr(0, 16)
  const desc =
    props.description.slice(0, 20) +
    (props.description.length > 20 ? '...' : '')
  if (props.name.length > trimmedString.length) {
    /* Apabila jumlah huruf > 21 maka akan ditambahkan ... */
    trimmedString =
    ...
    /* Apabila lebih kecil dari 21 maka name nya akan seperti itu*/
        ...
        <div className="flex bg-white border border-gray-300 rounded-xl md:flex-row flex-col overflow-hidden items-center justify-start">
          <div className="relative w-64 h-64 md:w-32 md:h-32 flex-shrink-0">
            <div className="absolute left-0 top-0 w-full h-full block">
              <img
                className="w-full block max-w-full h-full object-cover"
                alt="gambar"
                src={props.image}
              />
            </div>
          ...
          <div className="px-4 flex flex-col md:mt-0 mt-2 md:text-left text-center">
            <p className="text-xl capitalize text-ellipsis">
              {' '}
              {trimmedString}{' '}
            </p>
            ...
            <div className="flex mt-4 justify-evenly">
              <div className="flex flex-col items-center">
                <EditIcon
                  _hover={{ color: '#48BB78' }}
                  color="green"
                  className="cursor-pointer mb-1 duration-700"
                  onClick={onOpen}
                />
          ...
          <ModalBody>
            <div className="flex flex-col">
              ...
              <Input
                value={name}
                className="my-4"
                placeholder="Masukkan nama roti"
            ...
            <div className="flex flex-col">
              ...
              <Textarea
                value={description}
                className="my-4"
                placeholder="Masukkan deskripsi roti"
